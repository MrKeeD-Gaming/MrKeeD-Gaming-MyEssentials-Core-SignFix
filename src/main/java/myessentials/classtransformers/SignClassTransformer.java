...
/**
 * Do a simple modification on {@link net.minecraft.tileentity.TileEntitySign} to add a custom field and two static
 * invocations. <br/>
...
public class SignClassTransformer implements IClassTransformer {
    ...
    public static void writeToNBT(Object sign, NBTTagCompound tagCompound) {
        ...
        if (modData != null) tagCompound.setTag(TAG_ROOT, modData);
    }
    ...
    private class SignGeneratorAdapter extends GeneratorAdapter {
         ...
         * @param localMethodName The static method on {@link SignClassTransformer} that will be executed before the
         *                        visited method returns
         */
    ...
    public byte[] transform(String name, String srgName, byte[] bytes) {
        ...
        if ("net.minecraft.tileentity.TileEntitySign".equals(srgName)) {
            ...
            writer.visitField(Opcodes.ACC_PUBLIC, FIELD_NAME, "Lnet/minecraft/nbt/NBTTagCompound;", null, null)
                    .visitEnd();

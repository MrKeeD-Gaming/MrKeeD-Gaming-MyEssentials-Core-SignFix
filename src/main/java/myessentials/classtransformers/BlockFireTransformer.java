...
/**
 * Patches BlockFire to add a hook for the {@link myessentials.event.ModifyBlockEvent}. <br/>
 * For the method updateTick and tryCatchFire:
 *
 * <pre>
 * <code>world.setBlock(x, y, z, block, meta, flags) is replaced by
 * ModifyBlockEvent.checkAndSetBlock(world, x, y, z, block, meta, flags)</code>
 * </pre>
 *
 * For the method tryCatchFire:
 *
 * <pre>
 * <code>world.setBlockToAir(x, y, z) is replaced by
 *  ModifyBlockEvent.checkAndSetBlockToAir(world, x, y, z)</code>
 * </pre>
 *
 */
            ...
            if ((methodTransformed.equals("func_149674_a") || methodTransformed.equals("updateTick"))
                ...
                if (owner.equals("net/minecraft/world/World") && name.equals("func_147465_d")
                    ...
                    super.visitMethodInsn(
                            ...
                            "myessentials/event/ModifyBlockEvent",
                            "checkAndSetBlock",
                            "(Lnet/minecraft/world/World;IIILnet/minecraft/block/Block;II)Z",
                            false);
                    return;
                    ...
                    super.visitMethodInsn(
                            ...
                            "myessentials/event/ModifyBlockEvent",
                            "checkFlagAndBlock",
                            "(ZLnet/minecraft/world/World;III)Z",
                            false);

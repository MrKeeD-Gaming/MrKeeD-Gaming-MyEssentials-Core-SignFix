...
/**
 * An easy way to register all the TypeAdapters to a Gson object. Extend this if you want a serializer and call the
 * createBuilder() method when instantiating the Gson object. This will diminish greatly the amount of code when

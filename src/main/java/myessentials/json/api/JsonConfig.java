...
/**
 * An abstract class for all JSON configs. Instantiating the gson and gsonType is needed. Methods are usually overriden
 * but called inside their overriden method.
 */

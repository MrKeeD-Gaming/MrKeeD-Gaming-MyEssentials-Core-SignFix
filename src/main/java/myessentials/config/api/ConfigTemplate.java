...
/**
 * Config class which contains most of the basic functionality needed in a config. All the fields of the type
 * ConfigProperty inside the extended class are automatically added to the loading list. Other ConfigProperties can be
 * added externally.
 */
public abstract class ConfigTemplate {
    ...
    /**
     * Adds a ConfigProperty instance which can then be loaded/saved in the config. It will automatically reload if
     * specified.
     */
            ...
            if (field.getType().isAssignableFrom(ConfigProperty.class)) {
                try {
                    ...
                    MyEssentialsCore.instance.LOG.error(
                            "Failed to access " + field.getName()
                                    + " while binding to config "
